export default {
  ...
  backup: {
    permission_title: '权限提示',
    permission_desc: '只有管理员用户才能访问资源备份',
    export_resource: '导出资源',
    export_desc: '将数据源、数据集、仪表板或数据大屏导出为备份文件',
    import_resource: '导入资源',
    import_desc: '从备份文件导入数据源、数据集、仪表板或数据大屏',
    export_type: '导出类型',
    select_export_type: '请选择导出类型',
    datasource: '数据源',
    dataset: '数据集',
    dashboard: '仪表板',
    dataview: '数据大屏',
    ...
    select_export_datasource: '请选择要导出的数据源',
    select_export_dataset: '请选择要导出的数据集',
    export_options: '导出选项',
    compress_file: '压缩文件',
    select_import_file: '选择导入文件',
    select_file: '选择文件',
    file_format_tip: '支持 .debk、.json、.zip 格式',
    version: '版本',
    type: '类型',
    export_time: '导出时间',
    include_count: '包含数量',
    import_mode: '导入模式',
    create_new: '创建新资源（重名自动重命名）',
    overwrite_same: '覆盖同名资源',
    export_success: '导出成功',
    export_failed: '导出失败',
    import_success: '导入成功',
    import_failed: '导入失败',
    upload_failed: '文件上传失败',
    upload_failed_no_id: '文件上传失败，未获取到文件ID',
    preview_failed: '文件预览失败',
    select_import_file_warning: '请选择要导入的文件',
    export_history: '导出历史',
    file_name: '文件名',
    resource_count: '资源数量',
    status: '状态',
  ...
  user: {
    ...
    role_management: {
      ...
      permission_saved: '权限保存成功',
      search_placeholder: '搜索角色名称或编码',
      status_all: '全部',
      create_success: '角色创建成功',
      update_success: '角色更新成功',
      delete_success: '角色已删除',
      name_required: '角色名称不能为空',
      name_length: '长度在 2 到 50 个字符',
      code_required: '角色编码不能为空',
      code_length: '长度在 2 到 50 个字符',
      code_format: '只能包含字母、数字和下划线',
      no_roles: '暂无角色'
    },
