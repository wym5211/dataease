export default {
  ...
  backup: {
    permission_title: '權限提示',
    permission_desc: '只有管理員用戶才能訪問資源備份',
    export_resource: '導出資源',
    export_desc: '將資料來源、資料集、儀表板或資料大螢幕導出為備份檔案',
    import_resource: '導入資源',
    import_desc: '從備份檔案導入資料來源、資料集、儀表板或資料大螢幕',
    export_type: '導出類型',
    select_export_type: '請選擇導出類型',
    datasource: '資料來源',
    dataset: '資料集',
    dashboard: '儀表板',
    dataview: '資料大螢幕',
    ...
    select_export_datasource: '請選擇要導出的資料來源',
    select_export_dataset: '請選擇要導出的資料集',
    export_options: '導出選項',
    compress_file: '壓縮檔案',
    select_import_file: '選擇導入檔案',
    select_file: '選擇檔案',
    file_format_tip: '支援 .debk、.json、.zip 格式',
    version: '版本',
    type: '類型',
    export_time: '導出時間',
    include_count: '包含數量',
    import_mode: '導入模式',
    create_new: '創建新資源（同名自動重新命名）',
    overwrite_same: '覆寫同名資源',
    export_success: '導出成功',
    export_failed: '導出失敗',
    import_success: '導入成功',
    import_failed: '導入失敗',
    upload_failed: '檔案上傳失敗',
    upload_failed_no_id: '檔案上傳失敗，未獲取到檔案ID',
    preview_failed: '檔案預覽失敗',
    select_import_file_warning: '請選擇要導入的檔案',
    export_history: '導出歷史',
    file_name: '檔案名稱',
    resource_count: '資源數量',
    status: '狀態',
  ...
  user: {
    ...
    user_management: {
      ...
      create_time: '建立時間',
      actions: '操作',
      search_placeholder: '搜尋使用者名稱、暱稱或電子郵件',
      status_all: '全部',
      status_filter: '狀態篩選',
      role_filter: '角色篩選',
      confirm_delete: '確定要刪除該使用者嗎？此操作不可恢復',
      confirm_reset_password: '確定要重設該使用者的密碼嗎？',
      delete_success: '使用者已刪除',
      create_success: '使用者建立成功',
      update_success: '使用者資訊已更新',
      reset_password_success: '密碼已重設',
      cannot_delete_self: '不能刪除目前登入使用者',
      cannot_delete_admin: '不能刪除系統管理員帳戶',
      username_required: '使用者名稱不能為空',
      username_format: '只能包含字母、數字、底線',
      username_length: '長度在 3 到 50 個字元',
      nick_name_required: '暱稱不能為空',
      nick_name_length: '長度在 2 到 50 個字元',
      email_required: '電子郵件不能為空',
      email_format: '請輸入正確的電子郵件地址',
      phone_format: '請輸入正確的手機號碼',
      password_required: '密碼不能為空',
      password_length: '密碼長度至少6位',
      role_required: '請至少選擇一個角色',
      no_users: '暫無使用者',
      no_roles: '暫無角色選項',
      no_groups: '暫無分組選項'
    },
