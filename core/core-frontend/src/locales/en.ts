export default {
  ...
  system: {
    ...
    backup_settings: 'Resource backup',
  ...
  backup: {
    permission_title: 'Permission Notice',
    permission_desc: 'Only admin users can access resource backup',
    export_resource: 'Export Resource',
    export_desc: 'Export datasources, datasets, dashboards or data screens as backup files',
    import_resource: 'Import Resource',
    import_desc: 'Import datasources, datasets, dashboards or data screens from backup files',
    ...
    combined: 'Complete Export (includes all)',
    select_datasource: 'Select Datasource',
    select_dataset: 'Select Dataset',
    select_export_datasource: 'Please select datasources to export',
    select_export_dataset: 'Please select datasets to export',
    export_options: 'Export Options',
    compress_file: 'Compress file',
    select_import_file: 'Select Import File',
    select_file: 'Select File',
    file_format_tip: 'Supports .debk, .json, .zip formats',
    version: 'Version',
    type: 'Type',
    export_time: 'Export Time',
    include_count: 'Include Count',
    import_mode: 'Import Mode',
    create_new: 'Create new resource (rename if duplicate)',
    overwrite_same: 'Overwrite duplicate resource',
    export_success: 'Export successful',
    export_failed: 'Export failed',
    import_success: 'Import successful',
    import_failed: 'Import failed',
    upload_failed: 'File upload failed',
    upload_failed_no_id: 'File upload failed, no file ID obtained',
    preview_failed: 'File preview failed',
    select_import_file_warning: 'Please select a file to import',
  ...
  user: {
    ...
    user_management: {
      ...
      cannot_delete_admin: 'Cannot delete the system administrator account',
      username_required: 'Username cannot be empty',
      username_format: 'Can only contain letters, numbers, and underscores',
      username_length: 'Length between 3 and 50 characters',
      nick_name_required: 'Nickname cannot be empty',
      nick_name_length: 'Length between 2 and 50 characters',
    ...
    role_management: {
      ...
      search_placeholder: 'Search role name or code',
      status_enabled: 'Enabled',
      status_disabled: 'Disabled',
      status_all: 'All',
      ...
      name_required: 'Please enter role name',
      name_length: 'Length between 2 and 50 characters',
      code_required: 'Please enter role code',
      code_format: 'Can only contain letters, numbers, and underscores',
      code_length: 'Length between 2 and 50 characters',
      status_required: 'Please select status',
      permission_placeholder: 'Permission assignment feature is under development',
      current_role: 'Current Role',
      return_to_list: 'Return to Role List'
    },
